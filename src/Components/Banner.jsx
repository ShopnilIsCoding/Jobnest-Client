      ...
      return (
        <div className='container'>
          ...
          <div className="buttonslide text-4xl text-violet-300">
            <button className="prev btn-outline border-2 border-error btn-error" onClick={handlePrev}><BiSkipPrevious></BiSkipPrevious></button>
            <button className="next btn-outline border-2 border-error btn-error" onClick={handleNext}><BiSkipNext></BiSkipNext></button>
          </div>
        </div>
        </div>
      );
